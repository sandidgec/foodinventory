...
try {
	...
	$movement = new Movement(null, 1, 2, 2, 1, 5.25, $date, "T", 7.50);
	$movement->insert($pdo);
	var_dump($movement);
...
$stringStart = "<table>";
$tableHeaders = "<thead><tr><th>Movement ID</th><th>From Location ID</th><th>To Location ID</th><th>Product ID</th>
